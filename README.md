...
### For Candidates
- **AI Interview Simulator (STEVEN Bot)** — Real-time voice-based mock interviews powered by Google Gemini AI
...
- [STEVEN Bot Documentation](STEVEN_BOT_DOCUMENTATION.md)
