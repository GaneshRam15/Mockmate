...
import { getUserInterviews, deleteInterview, getRound1AptitudeResults } from "@/lib/firebaseService";
  ...
  useEffect(() => {
    const loadInterviews = async () => {
      ...
      try {
        ...
        console.log('Round 1 results:', round1);
  ...
  return (
    <Layout>
      <div className="container max-w-4xl mx-auto px-4 py-12">
        ...
        {interviews.length === 0 && round1Results.length === 0 ? (
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-semibold flex items-center gap-2">
              <Briefcase className="h-5 w-5 text-mockmate-primary" />
              Round 2 - Mock Interview Results
            </h2>
            {interviews
