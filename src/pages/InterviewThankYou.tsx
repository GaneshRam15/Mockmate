    ...
    <Layout>
      <div className="container max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-md mx-auto">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold text-mockmate-primary">{Math.round((countdown / 30) * 100)}%</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* History Card */}
          <Card className="border-2 border-mockmate-primary/30 hover:border-mockmate-primary/60 transition-all duration-300 hover:shadow-lg">
            <CardHeader className="pb-4">
              <div className="flex items-start justify-between">
                <div className="rounded-lg bg-mockmate-primary/10 p-3 mb-3">
                  <History className="h-8 w-8 text-mockmate-primary" />
                </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button 
            ...
            size="lg"
            onClick={() => navigate("/history")}
            className="min-w-[200px] bg-mockmate-primary hover:bg-mockmate-primary/90"
          >
