            ...
            {botInterviewHistory.length === 0 ? (
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">Experience real-time AI interviews with STEVEN</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">STEVEN's Questions:</span>
                                <span className="font-medium">
                                  {result.conversationLog?.filter(m => m.role === 'steven')?.length || 0}
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <Button 
                            ...
                            onClick={() => {
                              ...
                              alert(`Transcript:\n\n${result.conversationLog.map(m => 
                                `${m.role === 'steven' ? 'STEVEN' : 'YOU'}: ${m.message}`
                              ).join('\n\n')}`);
                            }}
                          >
