...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const loadInterviews = async () => {
      try {
        console.log('🔄 AdminDashboard: Loading interviews from Firestore...');
        ...
        try {
          ...
          setTotalResumes(resumesSnapshot.size);
  ...
  const getStatusBadge = (interview: InterviewSession) => {
    if (interview.aborted) {
      ...
      return <Badge className="bg-mockmate-primary">Selected</Badge>;
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg flex items-center">
                <Users className="mr-2 h-5 w-5 text-mockmate-primary" />
                Overview
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Settings className="mr-2 h-5 w-5 text-mockmate-primary" />
              Role Management
            </CardTitle>
            <CardDescription>
