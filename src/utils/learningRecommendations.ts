...
export const generateResumeSkillGaps = (
  ...
  const requiredSkills = roleSkillMaps[targetRole] || [];
  ...
  const learningPaths = generateLearningPaths(missingSkills, targetRole);
  const recommendedCourses = getRecommendedCourses(missingSkills, targetRole, atsScore / 10);
